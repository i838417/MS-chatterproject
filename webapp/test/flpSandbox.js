		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hznschatterproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hznschatterproject-display": {
								"semanticObject": "hznschatterproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hzns.chatterproject",
									"url": sap.ui.require.toUrl("hzns/chatterproject")
								}
							}
						}
					}
